...
# Military economic analyser v2.06-Fallout:Equestria
...
dict_wpn = {
        ...
        'wpn_name_mid':'Боевые машины пехоты старой серии',
        'wpn_name_old':'Боевые машины пехоты под списание',
        'wpn_age_mid':10,
        'wpn_age_old':20,
        'wpn_a':0.05,
        'wpn_b':0.0002,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Зенитные ракетно-пушечные комплексы. 4 пушки, 12 ракет. Масса: 30 тонн. Дальность огня: 20 км.',
        'wpn_troops_type':'СВ',
        'wpn_cost':10000000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.006,
...
dict_wpn_key = dict_wpn_key + 1
dict_wpn = {
        'wpn_name':'Самоходные ПТРК',
        'wpn_name_comment':'Бронетранспортеры с радаром наведения и противотанковыми ракетами. Масса 15 тонн. Дальность огня: 5 км.',
        'wpn_troops_type':'СВ',
        'wpn_cost':3000000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.002,
        'wpn_name_new':'Самоходные ПТРК новые',
        'wpn_name_mid':'Самоходные ПТРК устаревшие',
        'wpn_name_old':'Самоходные ПТРК под списание',
        'wpn_age_mid':10,
        'wpn_age_old':20,
        'wpn_a':0.05,
        'wpn_b':0.0002,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Роботизированные танкетки. Вооружены 30-мм автопушкой и управляемыми ракетами. Масса: 1.5 тонны.',
        'wpn_troops_type':'СВ',
        'wpn_cost':600000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.005,
        ...
        'wpn_b':0.0008,
        'wpn_c':2,
        # Оружие с боеприпасами весит 500 кг.
        'wpn_ammo_1_name':'Снаряды 30x165',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Различные автоматические винтовки под унифицированный патрон 6x48. Вес: 3-5 кг. Прицельная дальность: 500 м',
        'wpn_troops_type':'СВ',
        'wpn_cost':2000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.004,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Разгрузка, прицелы, связь. СИБЗ: шлем, защитный комбинезон, пластины, химкостюм. Вес: 10-20 кг.',
        'wpn_troops_type':'СВ',
        'wpn_cost':20000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.01,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Для сил специальных операций. Экзоскелет, сервоприводы, штурмовой щит. Масса: 100 кг; автономность: 8 часов.',
        'wpn_troops_type':'СВ',
        'wpn_cost':600000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.002,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Дивизионные пегасо-буксируемые орудия. Масса: 5 тонн; калибр: 150-мм; дальность огня: 20 км.',
        'wpn_troops_type':'АВ',
        'wpn_cost':1000000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.002,
...
dict_wpn = {
        ...
        'wpn_b':0.0001,
        'wpn_c':1.2,
        # 384 пусковые шахты тактических ракет:
        'wpn_ammo_1_name':'Зенитные ракеты средней дальности',
        'wpn_ammo_1_capacity':144,
        'wpn_ammo_1_expense':144,
        'wpn_ammo_2_name':'Зенитные ракеты большой дальности',
        'wpn_ammo_2_capacity':144,
        'wpn_ammo_2_expense':144,
        'wpn_ammo_3_name':'Тактические ядерные ракеты',
        'wpn_ammo_3_capacity':96,
        'wpn_ammo_3_expense':96,
        # 32 шахты стратегических ракет:
        'wpn_ammo_4_name':'Стратегические ядерные ракеты',
        'wpn_ammo_4_capacity':32,
        'wpn_ammo_4_expense':32,
        # Четрые батареи противоракетной обороны:
        'wpn_ammo_5_name':'300-ТВт лазеры',
        'wpn_ammo_5_capacity':160,
        'wpn_ammo_5_expense':160,
        }
metadict_wpn[dict_wpn_key] = dict_wpn
...
dict_wpn = {
        ...
        'wpn_name_comment':'Водоизмещение: 10 000 тонн. Атомные силовые установки. 16 пусковых шахт, торпеды.',
        'wpn_troops_type':'ВМФ',
        'wpn_cost':3000000000,
        'wpn_cost_currency':'Эквестрийские биты',
        'wpn_budget':0.01,
...
dict_wpn = {
        ...
        # 96 пусковых шахт тактических ракет:
...
dict_wpn = {
        ...
        # 36 пусковых шахт тактических ракет
        'wpn_ammo_6_name':'Зенитные ракеты средней дальности',
        'wpn_ammo_6_capacity':36,
        'wpn_ammo_6_expense':36,
        }
