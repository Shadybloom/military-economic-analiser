...
# Military economic analyser v2.07-Fallout:Equestria
...
# 2016-08-13 Хочется знать, сколько металла тратят на танки, сколько тротила на снаряды, ракетного топлива на ракеты. Сейчас я указываю только топливо в литрах, но лучше сделать списки материалов из которых состоит техника.
# А ещё лучше вложенные списки! Боевой модуль, в котором пушка и пулемёт! К модулю боекомплект, в котором металл и взрывчатка. можно будет считать себестоимость из суммы стоимости деталей и по нормо-часам на сборку. Но это скорее подходит большой стратегии, нежели маленькому скрипту под рассказа.

# 2016-08-19 Было бы очень клёво сделать базу данных с вооружением дивизий разных видов войск, а скрипт научить самостоятельно вооружать дивизии по средствам, выделенным на вид войск. Правда для этого потребуется переписать скрипт почти целиком.
...
# Вооружённые силы России (2015 год, очень подробно):
...
dict_wpn = {
        ...
        'wpn_name_comment':'15-тонные колёсные и гусеничные БТР, вооружены пулемётом и АГС. Десант: 10 солдат; экипаж — двое.',
...
dict_wpn = {
        ...
        'wpn_name_old':'Лёгкие танки под списание',
        'wpn_age_mid':10,
        'wpn_age_old':20,
        'wpn_a':0.05,
        'wpn_b':0.0004,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Гесеничные машины массой в 50 тонн. 120-мм пушка, радар, активная защита. Трое членов экипажа.',
        'wpn_troops_type':'СВ',
        'wpn_cost':6000000,
...
dict_wpn = {
        ...
        'wpn_name_old':'Штурмовые роботы не существующие',
        'wpn_age_mid':5,
        'wpn_age_old':10,
        'wpn_a':0.1,
        'wpn_b':0.0006,
...
dict_wpn = {
        ...
        'wpn_name_comment':'Мобильные комплексы для запуска баллистических ракет. Масса 30 тонн; дальность 120 км.',
        'wpn_troops_type':'СВ',
        'wpn_cost':4000000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'ПТРК и ПЗРК. Станок для ракеты, тепловизор, система наведения. Масса: 30 кг (с ракетой 60 кг)',
        'wpn_troops_type':'СВ',
        'wpn_cost':100000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_b':0.0004,
        'wpn_c':1.6,
        # Патронный короб и рукав плюс магазин гранатомёта — 10 кг.
        'wpn_ammo_1_name':'Патроны 6x48',
        'wpn_ammo_1_capacity':250,
        'wpn_ammo_1_expense':5000,
        'wpn_ammo_2_name':'Выстрелы АГС',
...
dict_wpn_key = dict_wpn_key + 1
dict_wpn = {
        'wpn_name':'Автоматические винтовки',
        'wpn_name_comment':'Скорострельные винтовки под унифицированный патрон 6x48. Вес: 3-5 кг. Прицельная дальность: 500 м',
        'wpn_troops_type':'СВ',
        'wpn_cost':2000,
        'wpn_maintenance':0.01,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Оружие полиции и экипажей боевых машин. Крепится на груди. Вес: 3 кг. Прицельная дальность: 50 м.',
        'wpn_troops_type':'СВ',
        'wpn_cost':1000,
        'wpn_maintenance':0.01,
        'wpn_cost_currency':'Эквестрийские биты',
        ...
        'wpn_b':0.0004,
        'wpn_c':1.6,
        # Барабанный магазин на 50 патронов.
        'wpn_ammo_1_name':'Патроны 6x48',
        'wpn_ammo_1_capacity':50,
        'wpn_ammo_1_expense':5000,
        }
...
dict_wpn = {
        ...
        'wpn_name_comment':'Разгрузка, аптечка, связь. СИБЗ: шлем, защитный комбинезон, пластины, химкостюм. Вес: 15 кг.',
        'wpn_troops_type':'СВ',
        'wpn_cost':20000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Пусковые установки комплекса зенитных ракет. Автомобильный прицеп, 8-тонная ракета.',
        'wpn_troops_type':'РВ',
        'wpn_cost':100000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        'wpn_name':'Рапторы',
        'wpn_name_comment':'Малозаметные многоцелевые экранолёты. 500 тонн взлётного веса; 120 тонн груза; 800 км/ч скорость; атомная СУ.',
        'wpn_troops_type':'ВВС',
        'wpn_cost':1000000000,
        'wpn_maintenance':0.1,
        'wpn_cost_currency':'Эквестрийские биты',
        ...
        'wpn_ammo_1_name':'Спарк-батареи',
        'wpn_ammo_1_capacity':800,
        'wpn_ammo_1_expense':8000,
        # Может нести в грузовом отсеке 4x3 счетверённых контейнера крылатых ракет:
        'wpn_ammo_2_name':'Крылатые ракеты',
        'wpn_ammo_2_capacity':48,
        'wpn_ammo_2_expense':48,
        # Или 4x3 пусковых контейнеров дальних зенитных ракет:
        'wpn_ammo_3_name':'Зенитные ракеты большой дальности',
        'wpn_ammo_3_capacity':12,
        'wpn_ammo_3_expense':12,
        # Или 4x3 пусковых контейнеров противокорабельных ракет:
        'wpn_ammo_4_name':'Противокорабельные ракеты',
        'wpn_ammo_4_capacity':12,
        'wpn_ammo_4_expense':12,
        # Или 1000 авиабомб массой по 100 кг:
        'wpn_ammo_5_name':'Авиабомбы',
        'wpn_ammo_5_capacity':1000,
        'wpn_ammo_5_expense':60000,
        }
metadict_wpn[dict_wpn_key] = dict_wpn
...
dict_wpn = {
        ...
        'wpn_name_comment':'Десантные и транспортные экранолёты. 500 тонн взлётного веса; 120 тонн груза; 800 км/ч скорость; атомная СУ.',
        'wpn_troops_type':'ВВС',
        'wpn_cost':600000000,
        'wpn_maintenance':0.1,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_ammo_1_name':'Авиабомбы',
        'wpn_ammo_1_capacity':1,
        'wpn_ammo_1_expense':6,
        # Или 4x4 пусковые установки реактивных гранат:
        'wpn_ammo_2_name':'Реактивные гранаты',
        'wpn_ammo_2_capacity':16,
        'wpn_ammo_2_expense':48,
        'wpn_a':0.02,
        'wpn_b':0.0004,
...
dict_wpn = {
        ...
        'wpn_ammo_5_name':'Реактивные снаряды 210-мм',
        'wpn_ammo_5_capacity':24,
        'wpn_ammo_5_expense':72,
        # Две пусковые установки зенитных ракет средней дальности:
        'wpn_ammo_6_name':'Зенитные ракеты средней дальности',
        'wpn_ammo_6_capacity':64,
        'wpn_ammo_6_expense':128,
        # 4x4 пусковые установки дальних зенитных ракет:
        'wpn_ammo_7_name':'Зенитные ракеты большой дальности',
        'wpn_ammo_7_capacity':16,
        'wpn_ammo_7_expense':32,
...
dict_wpn = {
        ...
        'wpn_ammo_6_name':'Зенитные ракеты средней дальности',
        'wpn_ammo_6_capacity':32,
        'wpn_ammo_6_expense':64,
        # 2x4 пусковые установки противокорабельных ракет:
        'wpn_ammo_7_name':'Противокорабельные ракеты',
        'wpn_ammo_7_capacity':8,
        'wpn_ammo_7_expense':16,
        }
metadict_wpn[dict_wpn_key] = dict_wpn

dict_wpn_key = dict_wpn_key + 1
dict_wpn = {
        'wpn_name':'Универсальные десантные корабли',
        'wpn_name_comment':'Войсковые транспорты и плавучие доки. Водоизмещение 20 000 тонн. АСУ на 50 МВт, скорость 25 узлов.',
        'wpn_troops_type':'ВМФ',
        'wpn_cost':600000000,
        'wpn_maintenance':0.03,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'На четырёх танковых шасси. Масса 120 тонн, тепловая мощность 100 МВт, электроэнергия 30 МВт.',
        'wpn_troops_type':'ИВ',
        'wpn_cost':100000000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Минные заградители и разградители, мостоукладчики и путепрокладчики, ремонтные машины. Масса 30-60 тонн.',
        'wpn_troops_type':'ИВ',
        'wpn_cost':3000000,
        'wpn_maintenance':0.03,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Рабочие лошадки большой войны, тягачи для перевозки прицепов и полуприцепов массой до 60 тонн.',
        'wpn_troops_type':'ИВ',
        'wpn_cost':100000,
        'wpn_maintenance':0.02,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Для минирования инженерных сооружений, дорог и мостов. Масса: 200 кг; мощность взрыва 1-100 килотонн.',
        'wpn_troops_type':'ИВ',
        'wpn_cost':500000,
        'wpn_maintenance':0.01,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Сверхпрочные диски из углеродных нанотрубок, ёмкость 10 МДж/кг. Стоимость электроэнергии.',
        'wpn_troops_type':'ВПК',
        'wpn_cost':0.01,
        'wpn_maintenance':0.2,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Противотанковые ракеты управляемые с пусковой установки. Масса 30 кг. Дальность 5 км',
        'wpn_troops_type':'ВПК',
        'wpn_cost':25000,
        'wpn_maintenance':0.02,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Ракеты ПВО/ПРО дальнего радиуса. Активная РГСН. Масса 8000 кг (БЧ 200 кг). Высота: 40 км; дальность 250 км.',
        'wpn_troops_type':'ВПК',
        'wpn_cost':3000000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Баллистические ракеты малого радиуса. Масса 2000 кг (БЧ 200 кг). Дальность 120 км.',
        'wpn_troops_type':'ВПК',
        'wpn_cost':100000,
        'wpn_maintenance':0.05,
        'wpn_cost_currency':'Эквестрийские биты',
...
dict_wpn = {
        ...
        'wpn_name_comment':'Заряды изменяемой мощности от 1 до 100 килотонн. Радиус поражения до 3.5 км. Масса: 200 кг.',
        'wpn_troops_type':'ВПК',
        'wpn_cost':3000000,
        'wpn_maintenance':0.03,
        'wpn_cost_currency':'Эквестрийские биты',
